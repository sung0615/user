							...
							<ul class="navbar-nav align-items-center">
								...
								<li class="nav-item dropdown w-100 w-lg-auto">
									...
									<ul class="dropdown-menu">
										...
										<li><a class="dropdown-item" href="../pages/shop-single-2.html">Shop Single
												v2</a></li>
										<li><a class="dropdown-item" href="../pages/shop-wishlist.html">Shop
												Wishlist</a></li>
										<li><a class="dropdown-item" href="../pages/shop-cart.html">Shop Cart</a></li>
										<li><a class="dropdown-item" href="../pages/shop-checkout.html">Shop
												Checkout</a></li>
									</ul>
								</li>
								<li class="nav-item dropdown w-100 w-lg-auto">
									...
									<div class="dropdown-menu pb-0">
										<div class="row p-2 p-lg-4">
											<div class="col-lg-3 col-12 mb-4 mb-lg-0">
												...
												<a class="dropdown-item" href="../pages/shop-grid.html">Curd &
													Yogurt</a>
												<a class="dropdown-item" href="../pages/shop-grid.html">Eggs</a>
												<a class="dropdown-item" href="../pages/shop-grid.html">Buns &
													Bakery</a>
												<a class="dropdown-item" href="../pages/shop-grid.html">Cheese</a>
												<a class="dropdown-item" href="../pages/shop-grid.html">Condensed
													Milk</a>
												<a class="dropdown-item" href="../pages/shop-grid.html">Dairy
													Products</a>
											</div>
											<div class="col-lg-3 col-12 mb-4 mb-lg-0">
												...
												<a class="dropdown-item" href="../pages/shop-grid.html">Instant
													Mixes</a>
											...
											<div class="col-lg-3 col-12 mb-4 mb-lg-0">
												...
												<a class="dropdown-item" href="../pages/shop-grid.html">Water & Ice
													Cubes</a>
												<a class="dropdown-item" href="../pages/shop-grid.html">Soda &
													Mixers</a>
												<a class="dropdown-item" href="../pages/shop-grid.html">Health
													Drinks</a>
												<a class="dropdown-item" href="../pages/shop-grid.html">Herbal
													Drinks</a>
												<a class="dropdown-item" href="../pages/shop-grid.html">Milk Drinks</a>
											</div>
											<div class="col-lg-3 col-12 mb-4 mb-lg-0">
								...
								<li class="nav-item dropdown w-100 w-lg-auto">
									...
									<ul class="dropdown-menu">
										...
										<li><a class="dropdown-item" href="../pages/blog-category.html">Blog
												Category</a></li>
					...
					<div class="offset-lg-2 col-lg-8 col-12">
						...
						<form class="row needs-validation" novalidate>
							...
							<div class="col-md-6 mb-3">
								...
								<input type="text" id="contactFName" class="form-control" name="contactFName"
							...
							<div class="col-md-6 mb-3">
								...
								<input type="text" id="contactLName" class="form-control" name="contactLName"
							...
							<div class="col-md-12 mb-3">
								...
								<input type="text" id="contactCompanyName" name="contactCompanyName"
